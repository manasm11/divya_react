...
const ContactDetail = require("../src/ContactDetail.server")
const {
  db,
  findNote,
  insertNote,
...
async function renderReactTree(res, props, component) {
  await waitForWebpack();
  ...
  pipeToNodeWritable(React.createElement(component || ReactApp, props), res, moduleMap);
}
